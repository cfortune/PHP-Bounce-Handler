...
<LI>'autoresponse' (a vacation auto-response), or
...
if ($bouncehandler->is_RFC1892_multipart_report($head_hash)) {
    ...
    print "<h2 style='color:red;'>It's a Feedback Loop, ";
    if ($bouncehandler->is_hotmail_fbl) {
        print " in Hotmail Doofus Format (HDF?)</H2>";
    } else {
        print " in Abuse Feedback Reporting format (ARF)</H2>";
        echo "<TEXTAREA COLS=100 ROWS=12>";
        print_r($bouncehandler->fbl_hash);
        echo "</TEXTAREA>";
    }
} else {
    print "<h2 style='color:red;'>Not an RFC1892 multipart report</H2>";
