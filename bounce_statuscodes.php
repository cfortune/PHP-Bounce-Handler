<?php
# Generated by Make_statuscodes.php on 2019-05-18T23:56:00+00:00

# from https://www.iana.org/assignments/smtp-enhanced-status-codes/smtp-enhanced-status-codes-1.csv
#  and https://www.iana.org/assignments/smtp-enhanced-status-codes/smtp-enhanced-status-codes-3.csv
...
$status_code_subclasses['1.10']['title'] = "Recipient address has null MX";  # [RFC7505] (Standards Track); [RFC7504] (Standards Track)
...
$status_code_subclasses['3.2']['title'] = "System not accepting network messages";  # [RFC3463] (Standards Track); [RFC7504] (Standards Track)
$status_code_subclasses['3.2']['descr'] = "The host on which the mailbox is resident is not accepting messages. Examples of such conditions include an imminent shutdown, excessive load, or system maintenance. This is useful for both permanent and persistent transient errors.";
...
$status_code_subclasses['7.25']['title'] = "Reverse DNS validation failed";  # [RFC7372], Section 3.3 (Standards Track)
...
$status_code_subclasses['7.27']['title'] = "Sender address has null MX";  # [RFC7505] (Standards Track)
...
$status_code_subclasses['7.28']['title'] = "Mail flood detected";  # [draft-levine-mailbomb-header]
$status_code_subclasses['7.28']['descr'] = "The message appears to be part of a mail flood of similar abusive messages.";
$status_code_subclasses['7.29']['title'] = "ARC validation failure";  # [RFC-ietf-dmarc-arc-protocol-23]
$status_code_subclasses['7.29']['descr'] = "This status code may be returned when a message fails ARC validation";
